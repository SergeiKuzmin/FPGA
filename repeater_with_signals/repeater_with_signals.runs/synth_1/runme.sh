...
HD_PWD='D:/FPGA/fpga/repeater_with_signals/repeater_with_signals.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log repeater.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source repeater.tcl
