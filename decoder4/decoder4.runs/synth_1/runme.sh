...
HD_PWD='D:/FPGA/fpga/decoder4/decoder4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log decoder4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source decoder4.tcl
